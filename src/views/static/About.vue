<i18n>
  ...
  "people-1-heading": "Andrew Durso",
  "people-1-text": "Andrew ist Herpetologe und Postdoktorand am Institut für Global Health der Universität Genf. Er wurde in New York (USA) geboren und verbrachte seine Kindheit schlangenfangend in North Carolina. Er hat einen B.S. in Ökologie von der University of Georgia (2009), einen M.S. in Biologie von der Eastern Illinois University (2011) und einen PhD in Ökologie von der Utah State University (2016). In seinem Blog <a href='http://snakesarelong.blogspot.com/' target='_blank'>'Life is Short, but Snakes are Long'</a> schreibt er regelmässig über schlangenbezogene Themen. Aktuell ist er damit beschäftigt, Bilder von allen Schlangenarten weltweit zu sammeln, um eine App zu erstellen, die diese Bilder mithilfe von Machine Learning und der Unterstützung von Experten und Citizen Scientists identifizieren kann.",
